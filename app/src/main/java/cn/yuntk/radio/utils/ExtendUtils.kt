...
fun String.logE(tag: String? = null) {
    if (BuildConfig.DEBUG)
        Lg.e(this)
//        if (tag.isNullOrEmpty()) Lg.e(this) else LogUtils.e( this)
}

fun String.logI(tag: String? = null) {
    if (BuildConfig.DEBUG)
        if (tag.isNullOrEmpty()) Lg.i(this) else LogUtils.i( this)
}

fun String.logD(tag: String? = null) {
    if (BuildConfig.DEBUG)
        if (tag.isNullOrEmpty()) Lg.d(this) else LogUtils.d(this)
}

fun String.logV(tag: String? = null) {
    if (BuildConfig.DEBUG)
        if (tag.isNullOrEmpty()) Lg.v(this) else LogUtils.v( this)
}

fun String.logW(tag: String? = null) {
    if (BuildConfig.DEBUG)
        if (tag.isNullOrEmpty()) Lg.w(this) else LogUtils.w( this)
}
