...
//
//import static cn.yuntk.radio.Constants.AD_APP_BACKGROUND_TIME;
//
//
///**
...
//            }
//            XApplication.getInstance().isForeground = true;
//            if (!(activity instanceof SplashActivity)){
...
//                XApplication.getsInstance().isForeground = false;
...
//        long serverTime = SharedPreferencesUtil.getInstance().getLong(Constants.AD_SPREAD_PERIOD, 5);
