...
public class ListenerLockService extends Service {

    public static String status = "default";
    BroadcastReceiver receiver;

    public ListenerLockService() {
    }
...
//                            Intent lockscreen = new Intent(ListenerLockService.this, ScreenOffAcivity.class);
