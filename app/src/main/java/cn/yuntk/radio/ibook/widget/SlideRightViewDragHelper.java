    ...
    public SlideRightViewDragHelper(Context context, AttributeSet attrs) {
        ...
        viewDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelper.Callback() {
            ...
            public boolean tryCaptureView(View child, int pointerId) {
                LogUtils.showLog("tryCaptureView:pointerId:"+pointerId);
                return true;
            }

            @Override
            public int clampViewPositionHorizontal(View child, int left, int dx) {
                LogUtils.showLog("clampViewPositionHorizontal:left:"+left+":dx:"+dx);
                oldX = left;
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                LogUtils.showLog("onViewReleased:xvel:"+xvel+":yvel:"+yvel);
                if(oldX > 200){
