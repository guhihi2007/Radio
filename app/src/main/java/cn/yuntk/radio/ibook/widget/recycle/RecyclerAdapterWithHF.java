...
public class RecyclerAdapterWithHF extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public final void onBindViewHolder(final RecyclerView.ViewHolder vh, int position) {
        ...
        if (isHeader(position)) {
            ...
            onBindViewHolderHF((CommRecyclerViewHolder)vh, getRealPosition(position));
        }
    }
    ...
    public void onBindViewHolderHF(CommRecyclerViewHolder vh, int position) {
    ...
    public void onViewRecycled(RecyclerView.ViewHolder holder) {
        if(holder instanceof CommRecyclerViewHolder){
            mAdapter.onViewRecycled((CommRecyclerViewHolder)holder);
        }
    }
    ...
    private RecyclerView.Adapter<CommRecyclerViewHolder> mAdapter;

    public RecyclerAdapterWithHF(RecyclerView.Adapter<CommRecyclerViewHolder> adapter) {
        super();
    ...
    public void setAdapter(RecyclerView.Adapter<CommRecyclerViewHolder> adapter) {
        mAdapter = adapter;
    }
