...
public class ScreenOffAcivity extends AppCompatActivity implements OnPlayerEventListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listener_screen_off_acivity);
    ...
    private void init() {
        ...
        setAnim();
        //绑定收音机锁屏服务
        bindService(new Intent(this, LockService.class), conn, Context.BIND_AUTO_CREATE);
    }

    private ServiceConnection conn = new ServiceConnection() {
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            lockService = ((MyLockServiceBinder) service).getMService();
            lockService.setJump(true);
        }
    ...
    private void initMusic() {
        ...
        try {
            ...
            titleTv.setText(music.getZj_title());
    ...
    public void getDate() {
        ...
        week_show_tv.setText(cn.yuntk.radio.ibook.util.DateUtils.getWeek());
    }
    ...
    private void setAnim() {
        ...
        mAnimation.addFrame(getResources().getDrawable(R.mipmap.arrow_3), 200);
        mAnimation.addFrame(getResources().getDrawable(R.mipmap.arrow_4), 200);
        mAnimation.addFrame(getResources().getDrawable(R.mipmap.arrow_5), 400);
