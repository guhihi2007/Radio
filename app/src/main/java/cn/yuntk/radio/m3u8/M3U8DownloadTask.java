...
import cn.yuntk.radio.m3u8.bean.OnM3U8InfoListener;
...
public class M3U8DownloadTask {
    ...
    //最终文件保存的路径
    private String saveFilePath = Environment.getExternalStorageDirectory().getPath() + File.separator + "Radio_m3u8";
    //当前下载完成的文件个数
